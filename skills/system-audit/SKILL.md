...
3. Dispatch opus agent for **repo audit**: scan all `$HOME/` git repos. Per repo: branch, dirty state, stashes, worktrees, unmerged branches, sync status. Also check state files for stale/stuck records.

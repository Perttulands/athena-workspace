...
EXAMPLES:
  relay reserve "src/auth/**" --repo /home/perttu/oathkeeper --reason "bd-42 auth refactor"
...
EXAMPLES:
  relay reservations
  relay reservations --repo /home/perttu/oathkeeper --json
```
...
[Path]
PathModified=/home/perttu/.relay/wake/trigger
...
[Service]
Type=oneshot
ExecStart=/home/perttu/.openclaw/workspace/scripts/wake-gateway.sh "relay wake trigger"
```

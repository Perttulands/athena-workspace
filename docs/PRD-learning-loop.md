...
0 * * * * /home/perttu/.openclaw/workspace/scripts/score-templates.sh

# Prompt refinement check — daily at 03:00 UTC
0 3 * * * /home/perttu/.openclaw/workspace/scripts/refine-prompts.sh --auto

# Strategy report — weekly Sunday 00:00 UTC
0 0 * * 0 /home/perttu/.openclaw/workspace/scripts/weekly-strategy.sh
```

...
- Add `repos` key to `config/agents.json`:
  ```json
  "repos": {
    "/home/perttu/athena-web": { "test_cmd": "npm test", "timeout": 120 },
    "/home/perttu/oathkeeper": { "test_cmd": "go test ./...", "timeout": 300 },
    "/home/perttu/truthsayer": { "test_cmd": "go test ./...", "timeout": 300 }
  }
  ```
...
- Run: `bash -n scripts/centurion.sh`
- Expected: exit 0
- Run: `bash scripts/centurion.sh --status /home/perttu/athena-web 2>&1 || true`
...
- **Repos:** athena-web (`/home/perttu/athena-web`, npm test), oathkeeper (`/home/perttu/oathkeeper`, go test ./...), truthsayer (`/home/perttu/truthsayer`, go test ./...)

...
Truthsayer is a Go CLI anti-pattern scanner at `/home/perttu/truthsayer/`. It detects silent fallbacks, swallowed errors, bad defaults, and other patterns that mask failures — exactly the kind of bug that caused our dispatch.sh model routing disaster.

**PRD:** `/home/perttu/truthsayer/docs/PRD.md` (602 lines, definitive spec)
**Progress:** `/home/perttu/truthsayer/progress_truthsayer.txt`

## Current State (2026-02-13 17:48 UTC)

- **Build:** ✅ Compiles clean, binary at `/home/perttu/truthsayer/truthsayer`
...
UBS is installed at `/home/perttu/.local/bin/ubs` (multi-language scanner).
...
./truthsayer scan /home/perttu/.openclaw/workspace/scripts/  # Test against our scripts
```
...
| File | Purpose |
|------|---------|
| `/home/perttu/truthsayer/docs/PRD.md` | Definitive spec (602 lines) |
| `/home/perttu/truthsayer/progress_truthsayer.txt` | Build progress log |
| `/home/perttu/truthsayer/internal/rules/` | Rule implementations |
| `/home/perttu/truthsayer/internal/rules/registry.go` | DefaultRegistry — where rules get registered |
| `/home/perttu/truthsayer/internal/scanner/` | Go AST + regex scanners |
| `/home/perttu/truthsayer/internal/engine/` | Scan engine + file walker |
| `/home/perttu/truthsayer/internal/cli/` | CLI commands |
